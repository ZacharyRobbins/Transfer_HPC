...
SV_TW=2.0 # Starting biomass twigs
SV_SB=4.5 #Starting biomass small branch
SV_LB=8.5#Starting biomass large branch
SV_TR=14.9 # Starting biomass trunk
SV_DL=6.0 #Starting biomass dead leaves
SV_LG=2.0 #Starting biomass live grass
